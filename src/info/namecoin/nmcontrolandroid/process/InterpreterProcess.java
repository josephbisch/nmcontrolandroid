...
package info.namecoin.nmcontrolandroid.process;
...
import info.namecoin.nmcontrolandroid.ScriptApplication;
import info.namecoin.nmcontrolandroid.config.GlobalConstants;
import info.namecoin.nmcontrolandroid.support.Utils;
...
public class InterpreterProcess extends Process {
  ...
  public String getSdcardPackageDirectory() {
    return Utils.context.getExternalFilesDir(null).getAbsolutePath() + "/" + ScriptApplication.getThePackageName();
  }
