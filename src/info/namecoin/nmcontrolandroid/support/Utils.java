...
package info.namecoin.nmcontrolandroid.support;
        ...
        // context.getExternalFilesDir(null)
    		    ...
    		    if (!file.exists()) {
    		    	try {
    		    		...
    		    		Log.d(GlobalConstants.LOG_TAG, "createDirectoryOnExternalStorage created " + context.getFilesDir().getAbsolutePath() + "/" +path);
    				} catch (Exception e) {
